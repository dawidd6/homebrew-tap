class Devscripts < Formula
  ...
  bottle do
    ...
    sha256 "e61659756198da4881c8e55c071efe9b09c928f9cf520f6e8ef4b447d0189195" => :mojave
    sha256 "deca1b4a8fade53f5b9d0d1769b1a5e56738e1f6276138b2184792e573ecc3fe" => :x86_64_linux
  end
